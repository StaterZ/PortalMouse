...
public static class TestHelper {
	public const int k_xSize = 1000;
	public const int k_ySize = 1000;
	...
	public static Setup CreateTestSetup(bool shouldWrap) {
		Setup setup = new();
	...
	public static Setup CreateTestSetup100(bool shouldWrap) {
		Setup setup = new();
		Screen mainScreen = new(
			1,
